...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-dark-danger">
    <a href="index3.html" class="brand-link">
        <img src="dist/img/AdminLTELogo.png" alt="KIU" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">KIU ERP</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">KIU User</a>
            </div>
        </div>
